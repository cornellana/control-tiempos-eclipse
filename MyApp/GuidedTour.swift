...
enum TourContent {
    ...
    static let steps: [TourStep] = [
        ...
        .init(id: 26,
              ...
              name: "Explore around",
              detail: "Drags the map under a fixed crosshair and evaluates every point it lands on: total or partial, magnitude, length of totality and height of the Sun. The calculation is offline and instant, so you can sweep the ground around a target looking for the edge of the band. Your current point stays marked as a reference."),
        .init(id: 27,
              screenTitle: "Step 3 — Verification",
              icon: "bookmark.badge.plus",
              name: "Save Location",
              detail: "Files the explored point under a name, without leaving the map or writing the coordinates down. It goes to the same saved locations list as Step 1."),
        .init(id: 28,
              screenTitle: "Step 3 — Verification",
              icon: "checkmark.circle.fill",
              name: "Use this point",
              detail: "Adopts the explored point as the observation site and recomputes the eclipse for it. The location name is cleared, since it described the previous spot."),
        .init(id: 14,
              screenTitle: "Step 3 — Verification",
              icon: "arrow.right.circle.fill",
              name: "Continue",
